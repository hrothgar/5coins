...
<tr>
    <td valign='top'>
        <img src='/img/c3.png' width='158px' /><br/>
        <strong>(*3)</strong> The first three coins leave no room for a fourth.
    </td>
    <td valign='top'>
        <img src='/img/c4a.png' width='173px' /><br/>
    ...
    <td valign='top'>
        <img src='/img/c4b.png' width='171px' /><br/>
...
<tr>
    ...
    <td valign='top'>
        <img src='/img/c5a.png' width='182px' /><br/>
    ...
    <td valign='top'>
        <img src='/img/c5b.png' width='172px' /><br/>
